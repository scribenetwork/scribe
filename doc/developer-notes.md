...
Scribe Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 8800.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 8801 for connections and services them.
...
However, in open source software such as Scribe Core, where everyone uses
...
pay attention to for reviewers of Scribe Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Scribe Core uses tinyformat, which is type safe. Leave them out to avoid confusion
