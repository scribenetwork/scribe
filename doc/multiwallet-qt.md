...
Only requiring some minor changes is scribe.cpp.
...
Changes to scribe.cpp
----------------------
scribe.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
