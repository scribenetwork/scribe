 ...
 *
 *   // network
 *   CScribeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CScribeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ScribeNetwork
// //   -- signature requirements : Key1(User)
// class CScribeNetworkVariable : public CGovernanceObject
// {
// private:
