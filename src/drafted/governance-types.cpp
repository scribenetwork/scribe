...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ScribeNetwork") type = ScribeNetwork;
    if(strType == "ScribeNetworkVariable") type = ScribeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ScribeNetwork) s = "ScribeNetwork";
    if(type == ScribeNetworkVariable) s = "ScribeNetworkVariable";
