    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Scribe Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Scribe Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  scribe-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Scribe in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SCRIBE, 0.1 SCRIBE, 1 SCRIBE and 10 SCRIBE -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Scribe Core is shutting down...") + "<br /><br />" +
