    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Scribe Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #33ccff, stop: 1 #cc0000); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Scribe address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scribe: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Scribe Core"), this);
    aboutAction->setStatusTip(tr("Show information about Scribe Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Scribe Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Scribe addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Scribe addresses"));
    ...
    openAction->setStatusTip(tr("Open a scribe: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/information"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Scribe Core help message to get a list with possible Scribe Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Scribe Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Scribe network", "", count));
    } else {
...
{
    QString strTitle = tr("Scribe Core"); // default title
