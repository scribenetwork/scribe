...
#define BOOST_TEST_MODULE Scribe Test Suite

#include "test_scribe.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_scribe_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
