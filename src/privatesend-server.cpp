...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Scribe related functionality
...
/*
    ...
    allow endless transaction that would bloat Scribe and make it unusable. To
